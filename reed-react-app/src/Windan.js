        ...
        <section className="windan">
            ...
            <div className="project-what div-background">
                ...
                <h3 className="what-description">
                    I designed and deployed a menswear concept shop from scratch, despite having no prior web-development experience.
                </h3>
            </div>
            ...
            <div className="project-details project-windan">
                ...
                <div className="details-section">
                    <p className="project-windan windan-text">Clicking on a product image opens a new tab, redirecting the user to the product site.</p>
                </div>
